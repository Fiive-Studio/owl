    ...
    public static class ETexts
    {
        ...
        public static void LoadTexts()
        {
            lock (Texts)
            {
                ...
                Texts[ErrorType.XPMLEnumInvalid] = "La propiedad: '{0}' no es valida";
                Texts[ErrorType.XPMLPropertyInvalidValue] = "El valor: '{0}' no es valido para la propiedad: '{1}'";
                ...
                Texts[ErrorType.XPMLNumericValue] = "El valor : '{0}' de la propiedad: '{1}' debe ser numerico";
                ...
                Texts[ErrorType.XPMLPropertyDoesNotExist] = "La propiedad: '{0}' es obligatoria";
