...
{
    /// <summary>
    /// Represent a EDI Structure configuration
    /// </summary>
    public class EDIStructureOutput : StructureOutput
    {
        #region Properties
        ...
        public override XPMLSigning GetSigning()
        {
            ...
            signing.Restrictions.Add(new XPMLSigning.XPMLRestriction { TagName = "element-group-separator", PropertyName = "ElementGroupSeparator", Attribute = true, Tag = true, Mandatory = false, PropertyType = XPMLPropertyType.Char });
