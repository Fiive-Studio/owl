...
namespace Fiive.Owl.Formats.Output.XOML
{
    ...
    public class EDIStructureOutput : StructureOutput
    {
        ...
        public override XOMLSigning GetSigning()
        {
            ...
            signing.Restrictions.Add(new XOMLSigning.XOMLRestriction { TagName = "element-group-separator", PropertyName = "ElementGroupSeparator", Attribute = true, Tag = true, Mandatory = false, PropertyType = XOMLPropertyType.Char });
